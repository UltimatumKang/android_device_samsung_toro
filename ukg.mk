...
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.toro.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="toro-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="google/toro:4.2.2/JDQ39/573038:user/release-keys"
